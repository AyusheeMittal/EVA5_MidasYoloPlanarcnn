...
class Config():
    ...
    NAME = "plane"  # Override in sub-classes
    ...
    def __init__(self):
        ...
        self.dataFolder = 'anchors/' #options.anchorFolder
        
        self.OCCLUSION = 'occlusion' in '' #options.dataset
        
        self.loadAnchorPlanes('normal') #options.anchorType)
        self.PREDICT_DEPTH = True
        self.PREDICT_BOUNDARY = False
        self.PREDICT_NORMAL_NP = 'normal_np' in 'warping_refine' #options.suffix
        
        self.BILINEAR_UPSAMPLING = 'bilinear' in 'warping_refine' #options.suffix
        self.FITTING_TYPE = 0
        return
